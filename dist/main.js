...
async function run() {
    try {
        ...
        if (cacheHit) {
            ...
            core.info('No matching cache found, will create new cache after workflow completes');
            ...
            core.info('Registering post action to save cache after workflow completes');
